...
// //     <nav className={` ${
// //         scrolling
// //           ? 'fixed shadow-md shadow-black/10 top-0'
// //           : 'relative'
// //       } flex justify-between w-full mx-auto bg-white transition duration-500 text-black dark:bg-black dark:text-white px-20 py-6 z-[999]`}>
// //         <h1>Dev_Faruq</h1>
...
//             } w-full bg-white transition-all  duration-500 text-black dark:bg-black dark:text-white px-4 md:px-20 py-6 z-[999]`}
//         >
//             <div className='w-full max-w-[1200px] flex flex-col justify-center m-auto'>
//             <div className="flex items-center justify-between ">
//                 {/* Logo */}
//                 <h1 className="text-xl font-bold">Dev_Faruq</h1>
