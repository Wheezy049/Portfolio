...
const Footer = () => {
  return (
    <div
      id="contact"
      className="flex flex-col md:flex-row items-center justify-center w-full mt-20 mb-10 relative"
    >
      ...
      <div className="bg-[#FAFCFD] w-[90%] mx-auto md:mx-0 md:w-[500px] h-[240px] shadow-lg shadow-[#7BBAD724] rounded-[61px] px-10 py-6 text-[#000000]">
        <div className="bg-[#FAFCFD] w-full shadow-lg shadow-[#7BBAD724] rounded-[61px] px-4 py-2 mb-5">
          <h3 className="text-sm md:text-xl">
            {" "}
            <span className="mr-4">Email:</span> Olatoyesefaruq@gmail.com
          </h3>
        </div>
        ...
        <div className="bg-[#FAFCFD] text-[#000000] shadow-lg shadow-[#7BBAD724] w-[220px] rounded-[61px] py-4 px-6 absolute bottom-[60px]">
